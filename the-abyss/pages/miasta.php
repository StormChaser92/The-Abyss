...
$MIASTA_DANE = [
    ...
    'STOCKHOLM' => [
        ...
        'opis'  => 'Archipelag ciszy i neonowej logiki. Hakerzy piszą tu kod jak poeci.',
    ],
    'GOTHENBURG' => [
        'lat' => 57.7089, 'lng' => 11.9746, 'shard' => 'GOT-01',
        'kraj' => 'SZWECJA', 'flaga' => '🇸🇪', 'strefa' => 'Europe/Stockholm',
        'opis'  => 'Przemysłowe serce Skandynawii. Volvo, stocznie, zorganizowany chaos.',
    ],
    ...
    'OSLO' => [
        ...
        'opis'  => 'Fjordy jak sztylety, metal black w serwerowniach pod ratuszem.',
    ],
    'BERGEN' => [
        'lat' => 60.3913, 'lng' => 5.3221, 'shard' => 'BGO-01',
        'kraj' => 'NORWEGIA', 'flaga' => '🇳🇴', 'strefa' => 'Europe/Oslo',
        'opis'  => 'Drewniane doki Bryggen kryją najnowocześniejsze implanty Europy.',
    ],
    ...
    'COPENHAGEN' => [
        ...
        'opis'  => 'Hygge nad Nyhavn, piwnice z serwerami pirackimi pod parlamentem.',
    ],
    'AARHUS' => [
        'lat' => 56.1629, 'lng' => 10.2039, 'shard' => 'AAR-01',
        'kraj' => 'DANIA', 'flaga' => '🇩🇰', 'strefa' => 'Europe/Copenhagen',
        'opis'  => 'Studencka stolica biotechu. Tu rodzą się nowe implanty — i nowe uzależnienia.',
    ],
    ...
    'PRAGUE' => [
        ...
        'opis'  => 'Gotycka stolica absyntu i alchemii. Pod każdą wieżą ktoś planuje rewolucję.',
    ],
    'BRNO' => [
        'lat' => 49.1951, 'lng' => 16.6068, 'shard' => 'BRQ-01',
        'kraj' => 'CZECHY', 'flaga' => '🇨🇿', 'strefa' => 'Europe/Prague',
        'opis'  => 'Technologiczna stolica Moraw. Tutaj kodują wirusy silniejsze od granatów.',
    ],
    ...
    'BRUSSELS' => [
        ...
        'opis'  => 'Biurokratyczna twierdza Europy. Każdy formularz ma drugie dno.',
    ],
    'ANTWERP' => [
        'lat' => 51.2194, 'lng' => 4.4025, 'shard' => 'ANR-01',
        'kraj' => 'BELGIA', 'flaga' => '🇧🇪', 'strefa' => 'Europe/Brussels',
        'opis'  => 'Port czarnych diamentów — 80% światowego handlu, 100% legendarnych syndykatów.',
    ],
];
