...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   - wymagany_kierunek → null lub klucz kierunku z config/uniwersytet.php
                         (stopień zależy od etapu: 1 Licencjat, 2–3 Magister, 4 Doktor)
   - kierunek_od_etapu → od którego etapu studia są wymagane (domyślnie 1)
...
$ZAWODY_DANE = [
    ...
    'Aktor' => [
        ...
        'wymagany_kierunek' => 'teatr', 'kierunek_od_etapu' => 3,
        'kategoria' => 'sztuka',
        'rp' => [
    ...
    'Detektyw Policyjny' => [
        ...
        'wymagany_kierunek' => 'kryminologia',
        'kategoria' => 'sluzby',
        'rp' => [
    ...
    'Architekt' => [
        ...
        'wymagany_kierunek' => 'architektura',
        'kategoria' => 'technika',
        'rp' => [
    ...
    'Sportowiec Zawodowy' => [
        ...
        'wymagany_kierunek' => 'awf', 'kierunek_od_etapu' => 3,
        'kategoria' => 'sztuka',
        'rp' => [
    ...
    'Psycholog / Terapeuta' => [
        'opis' => 'Słuchasz, diagnozujesz, prowadzisz przez najciemniejsze zakamarki umysłu. Bez recept.',
        'wymagania' => ['Psychologia i Empatia' => 10, 'Hipnoza i Sugestia' => 5, 'Analiza Danych i Dedukcja' => 5, 'Mediacja i Rozwiązywanie Konfliktów' => 5],
        'wymagany_kierunek' => 'psychologia',
        'kategoria' => 'medycyna',
        'rp' => [
            'opis_spoleczny' => 'Gabinet z kanapą i przyciemnionym światłem. Przychodzą do Ciebie żony bossów, wypaleni gliniarze i dzieciaki z ulicy. Znasz lęki połowy miasta.',
            'umiejetnosci_bonus_proc' => [
                'Psychologia i Empatia' => 30,
                'Hipnoza i Sugestia' => 15,
                'Mediacja i Rozwiązywanie Konfliktów' => 15,
                'Analiza Danych i Dedukcja' => 10,
            ],
            'reputacja' => ['elita' => 2, 'ulica' => 1, 'syndykat' => 0, 'wladze' => 1, 'spoleczenstwo' => 3],
        ],
    ],

    'Ratownik Górski / Wodny' => [
        'opis' => 'Wyciągasz ludzi z lodowatej zatoki i z dachów wieżowców, zanim spadną.',
        'wymagania' => ['Pływanie i Nurkowanie' => 8, 'Wspinaczka Wysokogórska' => 8, 'Medycyna Uliczna' => 6, 'Kondycja i Wytrzymałość' => 8],
        'wymagany_kierunek' => 'zdrowie',
        'kategoria' => 'sluzby',
        'rp' => [
            'opis_spoleczny' => 'Czerwona kurtka i gwizdek. Nikt nie pyta, kogo ratujesz — liczy się, że wracasz z nim żywym. Szacunek od slumsów po marinę.',
            'umiejetnosci_bonus_proc' => [
                'Pływanie i Nurkowanie' => 25,
                'Wspinaczka Wysokogórska' => 25,
                'Medycyna Uliczna' => 15,
                'Kondycja i Wytrzymałość' => 10,
            ],
            'reputacja' => ['elita' => 1, 'ulica' => 3, 'syndykat' => 1, 'wladze' => 2, 'spoleczenstwo' => 4],
    ...
    'Urbanista' => [
        'opis' => 'Decydujesz, gdzie stanie wieżowiec, a gdzie zniknie dzielnica.',
        'wymagania' => ['Architektura i Konstrukcje' => 10, 'Prawo i Administracja' => 6, 'Analiza Danych i Dedukcja' => 6, 'Perswazja i Negocjacje' => 5],
        'wymagany_kierunek' => 'architektura',
        'kategoria' => 'biznes',
        'rp' => [
            'opis_spoleczny' => 'Deweloperzy zasypują Cię prezentami, mieszkańcy protestują pod ratuszem. Jedna linia na mapie i czyjaś kamienica idzie pod buldożer.',
            'umiejetnosci_bonus_proc' => [
                'Architektura i Konstrukcje' => 30,
                'Prawo i Administracja' => 15,
                'Analiza Danych i Dedukcja' => 10,
            ...
            'reputacja' => ['elita' => 3, 'ulica' => -1, 'syndykat' => 1, 'wladze' => 3, 'spoleczenstwo' => 0],
        ],
    ],

    'Dietetyk' => [
        'opis' => 'Układasz jadłospisy celebrytów i sportowców. Wiesz, co naprawdę jedzą.',
        'wymagania' => ['Biologia i Botanika' => 6, 'Chemia i Farmakologia' => 5, 'Sztuka Kulinarna i Gastronomia' => 6, 'Psychologia i Empatia' => 4],
        'wymagany_kierunek' => 'zdrowie',
        'kategoria' => 'medycyna',
        'rp' => [
            'opis_spoleczny' => 'Modelki, bokserzy i prezesi płacą za Twoje plany żywieniowe. Wiesz, kto bierze sterydy, kto głoduje przed galą i kto ukrywa chorobę.',
            'umiejetnosci_bonus_proc' => [
                'Sztuka Kulinarna i Gastronomia' => 20,
                'Biologia i Botanika' => 20,
                'Chemia i Farmakologia' => 15,
                'Psychologia i Empatia' => 10,
            ],
    ...
    'Kurator Muzeum' => [
        'opis' => 'Strzeżesz skarbów miasta i decydujesz, co warto pokazać.',
        'wymagania' => ['Historia i Antykwariat' => 10, 'Sztuki Plastyczne i Rzemiosło' => 5, 'Etykieta i Dobre Manery' => 6, 'Zarządzanie i Przywództwo' => 5],
        'wymagany_kierunek' => 'historia',
        'kategoria' => 'nauka',
        'rp' => [
            'opis_spoleczny' => 'Wernisaże, bankiety i ciche aukcje. Kolekcjonerzy zabiegają o Twoją opinię, złodzieje dzieł sztuki o plan ochrony. Autorytet elity.',
            'umiejetnosci_bonus_proc' => [
                'Historia i Antykwariat' => 30,
                'Etykieta i Dobre Manery' => 15,
                'Sztuki Plastyczne i Rzemiosło' => 10,
            ...
            'reputacja' => ['elita' => 4, 'ulica' => 0, 'syndykat' => 1, 'wladze' => 2, 'spoleczenstwo' => 2],
        ],
    ],
];
